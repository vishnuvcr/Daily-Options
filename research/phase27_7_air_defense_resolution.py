...
def main():
    ...
    result = {
        ...
        "contexts": {
            ...
            "hold_duration": contexts(segs, [r"for how much duration", r"how many days", r"hold the trade", r"days? to expiry"]),
            "expiry_date": contexts(segs, [r"expiry date", r"date is", r"days? are there for.*expiry"]),
            "strike_example": contexts(segs, [r"strike .*25,700", r"25,550", r"strike to sell", r"which strike we should"]),
            "range_probability": contexts(segs, [r"95\.4%", r"probability", r"will not break"]),
        },
