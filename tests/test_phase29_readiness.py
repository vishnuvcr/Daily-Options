...
def test_index_family_requires_both_pinned_partitions():
    inv = {
        "trademarkk": {"paths": {"options/NIFTY": {"status": "PRESENT", "file_count": 80}, "stocks_options": {"status": "PRESENT", "file_count": 2}}},
        "rissin": {"paths": {"upstox_intraday/NIFTY": {"status": "PRESENT", "file_count": 2}}},
    }
...
def test_stock_option_family_is_never_ready_without_strategy_specific_join():
    inv = {
        "trademarkk": {"paths": {"stocks_options": {"status": "PRESENT", "file_count": 200}, "options/NIFTY": {"status": "PRESENT", "file_count": 1}}},
        "rissin": {"paths": {"upstox_intraday/NIFTY": {"status": "PRESENT", "file_count": 1}}},
    }
