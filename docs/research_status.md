...
## 2026-09-24 — Phase 19 exec-v6 authoritative bridge

Fresh execution branch `phase-19-global-gap-credit-spread-exec-v6` is based on current main and uses the validated Phase 17 execution bridge. Frozen 512-cell strategy logic is unchanged.
